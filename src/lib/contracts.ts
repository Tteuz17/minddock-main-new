...
export const MESSAGE_ACTIONS = {
  ...
  CMD_DELETE_NOTEBOOK_SOURCES: "MINDDOCK_CMD_DELETE_NOTEBOOK_SOURCES",
  ...
  CMD_RENDER_PDF_OFFSCREEN: "MINDDOCK_CMD_RENDER_PDF_OFFSCREEN",
  OFFSCREEN_RENDER_PDF: "MINDDOCK_OFFSCREEN_RENDER_PDF",
  CMD_CREATE_CHECKOUT: "MINDDOCK_CMD_CREATE_CHECKOUT",
  CMD_BRAIN_MERGE: "MINDDOCK_CMD_BRAIN_MERGE",
  FETCH_SNIPER_TRANSCRIPT: "FETCH_SNIPER_TRANSCRIPT"
} as const
