...
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ref={ref}
    className={cn(
      "flex cursor-default select-none items-center gap-2 rounded-md px-2 py-1.5 text-sm text-text-secondary outline-none",
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      "glass z-50 min-w-[10rem] rounded-lg border border-white/8 p-1 shadow-elevation-2",
  ...
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      ...
      danger
        ...
        : "text-text-secondary focus:bg-white/8 focus:text-white",
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Label
    ref={ref}
    className={cn("px-2.5 py-1 text-xs font-medium text-text-tertiary uppercase tracking-wide", inset && "pl-8", className)}
    {...props}
  />
))
