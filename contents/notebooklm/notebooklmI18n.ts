...
export function resolveSourceFilterUiCopy(language = resolveNotebookLmLanguage()): SourceFilterUiCopy {
  if (language === "pt") {
    return {
      ...
      saveViewButton: "Salvar grupo",
      saveDialogAriaLabel: "Salvar grupo atual",
      saveDialogTitle: "Salvar grupo atual",
  ...
  return {
    ...
    saveViewButton: "Save group",
    saveDialogAriaLabel: "Save current group",
    saveDialogTitle: "Save current group",
