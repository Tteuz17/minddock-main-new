...
export const GoCopilot = ({ className }: { className?: string }) => {
  return (
    ...
    >
      <path
        d="M12 2.75a5.25 5.25 0 0 1 5.25 5.25v1.12a4.25 4.25 0 0 1 2.75 3.98v1.15a4.25 4.25 0 0 1-4.25 4.25h-7.5A4.25 4.25 0 0 1 4 14.25V13.1a4.25 4.25 0 0 1 2.75-3.98V8A5.25 5.25 0 0 1 12 2.75Z"
        stroke="currentColor"
        strokeWidth="1.8"
      />
      <path
        d="M8.5 19.25V17.5A1.5 1.5 0 0 1 10 16h4a1.5 1.5 0 0 1 1.5 1.5v1.75"
        stroke="currentColor"
        strokeWidth="1.8"
        strokeLinecap="round"
      />
